// src/auth.js - Centralized SHA-256 client-side authentication for Cascadia Portal

const PASS_HASH = '1639943cb52312351a24a8ab510d14032f3b1b314c5b138a475d13efa868fe76'; // Hash for "cascadia2026"
  ...
  overlay.innerHTML = `
    ...
    <style>
      #auth-overlay {
        ...
        background: #090b11; display: flex; align-items: center; justify-content: center;
        z-index: 2147483647; font-family: 'Inter', 'Noto Sans JP', sans-serif; color: #e8eaed;
        visibility: visible !important; opacity: 1 !important;
      }
      .auth-card {
        background: #121624; padding: 40px; border-radius: 24px; width: 100%; max-width: 360px;
        text-align: center; box-shadow: 0 20px 50px rgba(0,0,0,0.6); border: 1px solid rgba(255,255,255,0.06);
      ...
      #auth-pass:focus { border-color: #34d399; background: #0c0f17; box-shadow: 0 0 15px rgba(52, 211, 153, 0.15); }
      .auth-remember {
        display: flex; align-items: center; justify-content: center; cursor: pointer;
        font-size: 13px; color: #9ca3af; margin-bottom: 24px; gap: 8px; user-select: none;
      }
      .auth-remember input { width: 16px; height: 16px; accent-color: #34d399; cursor: pointer; }
      .auth-card button {
        width: 100%; padding: 16px; border-radius: 12px; border: none;
        background: linear-gradient(135deg, #34d399, #10b981); color: #090b11; font-weight: 800; font-size: 16px;
        cursor: pointer; transition: all 0.3s; box-shadow: 0 4px 12px rgba(52, 211, 153, 0.2);
      }
      .auth-card button:hover { opacity: 0.95; transform: translateY(-1px); box-shadow: 0 6px 16px rgba(52, 211, 153, 0.3); }
